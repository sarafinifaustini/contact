    ...
    <table class="table table-striped" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$sport->name}}</td>
                <td>{{$sport->email}}</td>
                <td>{{$sport->cat->category}}</td>
                <td><a href="{{ route('admin.user.edit', $sport->id)}}" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="{{ route('admin.user.destroy', $sport->id)}}" method="post">
                        @csrf
                        @method('DELETE')
