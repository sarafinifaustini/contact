...
<div class="uper">
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <table class="table table-striped" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$business->cat->category}}</td>
                <td><a href="{{ route('admin.user.edit', $business->id)}}" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="{{ route('admin.user.destroy', $business->id)}}" method="post">
                        @csrf
                        @method('DELETE')
    ...
    {{-- <div class="mt-4">{{ $businesss->links() }}</div> --}}
